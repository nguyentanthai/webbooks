<?php session_start() ?>
<div class="container-fluid w-m-p-0">
	<form action="" id="login-frm">
		<div class="login-header">Đăng Nhập</div>
		<div class="form-group display-grid">
			<label for="" class="control-label">Email</label>
			<input id="email" type="email" name="email" placeholder="Nhập email của bạn" class="form-control">
			<span class="form-message"></span>
		</div>
		<div class="form-group display-grid pos-re">
			<label for="" class="control-label">Password</label>
			<input id = "password" type="password" name="password" placeholder="Nhập password của bạn" class="form-control form-control-password">
			<span class="form-message"></span>
		...
		<button class="button btn btn-primary btn-sm btn-submit">Đăng Nhập</button>
		<button class="button btn btn-secondary btn-sm btn-submit" type="button" data-dismiss="modal">Cancel</button>
	</form>
</div>
...
<script>
	...
	// 			}else{
	// 				$('#login-frm').prepend('<div class="alert alert-danger">Email hoặc password không đúng.</div>')
	// 	end_load()
	// 			}
	// 		}
	// 	})
	...
	Validator({
        ...
        //     return document.querySelector('#form-check #password').value
